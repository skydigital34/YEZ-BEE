...
import {
  ...
  Warehouse, TicketPercent, Star, ArrowLeftRight, BarChart3,
  FileText, Megaphone, Search, FileEdit, Truck, Settings,
  ChevronLeft, ChevronRight, Menu, X, Bell, LogOut, User,
