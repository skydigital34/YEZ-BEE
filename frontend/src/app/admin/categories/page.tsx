...
import {
  ...
  Edit2, Trash2, FolderTree, X, Save,
  ToggleLeft, ToggleRight, Sparkles
} from 'lucide-react'
import { YEZBEE_CATEGORIES, CategoryConfig, SubcategoryConfig } from '@/data/categories'
...
export default function CategoriesPage() {
  ...
  // Build taxonomy with live DB product counts
