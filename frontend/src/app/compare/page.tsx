...
const INITIAL_PRODUCTS: CompareProduct[] = [
  {
    ...
    rating: 4.9,
    reviews: 128,
    fabric: 'Pure Mulberry Crepe Silk',
    fit: 'Bespoke Royal Fit',
    neck: 'Deep Sweetheart Neck',
    sleeve: 'Full Sleeves',
    length: 'Floor Length Gown',
    pattern: 'Handcrafted Zardozi',
    colorOptions: 4,
    inStock: true,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 89,
    fabric: 'Sequined Satin Silk',
    fit: 'Slim A-Line',
    neck: 'Off-Shoulder',
    sleeve: 'Sleeveless',
    length: 'Maxi Gown',
    pattern: 'Hand-sewn Sequins',
    colorOptions: 3,
    inStock: true,
  ...
  },
  {
    ...
    neck: 'Unstitched Blouse Piece',
    sleeve: 'Customizable',
    length: '6.5 Meters with Blouse',
