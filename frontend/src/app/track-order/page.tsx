...
import { Package, Search, CheckCircle2, Clock, Truck, ShieldCheck, MapPin, AlertCircle, ArrowRight, HelpCircle } from 'lucide-react';
...
export default function TrackOrderPage() {
  ...
  const handleTrackOrder = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      setSearched(true);
      // If user inputs 'YEZ12345' or any demo ID, show mock result, else error
