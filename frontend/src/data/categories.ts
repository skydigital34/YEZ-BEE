...
export const YEZBEE_CATEGORIES: CategoryConfig[] = [
  {
    ...
    banner: '/images/Yez bee/1/casuals_maternity_feeding_kurti (2).jpg',
    sortOrder: 1,
  ...
  },
  {
    ...
    banner: '/images/Yez bee/6/bestconverter_compressed_1.jpg',
    sortOrder: 2,
    hasFeedingSplit: true,
    subcategories: [
      {
  ...
  },
  {
    ...
    banner: '/images/Yez bee/10/bestconverter_compressed_1.jpg',
    sortOrder: 3,
    hasFeedingSplit: true,
    subcategories: [
      {
  ...
  },
  {
    ...
    image: '/images/Yez bee/2/green_casual_maternity_feeding (2).jpg',
    banner: '/images/Yez bee/2/green_casual_maternity_feeding (2).jpg',
    sortOrder: 4,
  ...
  },
  {
    ...
    image: '/images/Yez bee/5/bestconverter_compressed_1.jpg',
    banner: '/images/Yez bee/5/bestconverter_compressed_1.jpg',
    sortOrder: 6,
    hasFeedingSplit: false,
    subcategories: [],
  },
