  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-2 right-2 flex items-center justify-between z-20 pointer-events-none">
        ...
        {/* Dedicated Drag Handle Icon (Touch Action None for mobile compatibility) */}
        {!isOverlay && (
          <button
            type="button"
            {...attributes}
      ...
      {/* Hover Action Overlay & Quick Buttons */}
...
export default function ProductMediaSortable({
  ...
  // Setup sensors with activation constraint to distinguish click vs drag
  const sensors = useSensors(
    useSensor(PointerSensor, {
      activationConstraint: {
        distance: 4, // 4px movement before drag activates
      },
    }),
    useSensor(TouchSensor, {
      activationConstraint: {
        delay: 150, // 150ms press before drag on touch devices
        tolerance: 5,
      },
    }),
