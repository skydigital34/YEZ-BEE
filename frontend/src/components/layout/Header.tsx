    ...
    <>
      ...
      >
        <div className="mx-auto flex min-h-[56px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center shrink-0">
            <Link href="/" className="shrink-0 group flex items-center">
              <Image
                ...
                priority
                className={cn(
                  'h-11 sm:h-13 lg:h-14 w-auto object-contain transition-transform duration-300 group-hover:scale-105',
          ...
          {/* Center: Primary Desktop Navigation (Centered in Header) */}
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <Link
              href="/account"
              className={cn(
                'hidden sm:flex rounded-full p-2.5 transition-all duration-200 hover:scale-105',
                isSolidHeader
                  ? 'text-[var(--color-dark)] hover:bg-[var(--color-warm-white)]'
                  : 'text-white hover:bg-white/10'
              )}
