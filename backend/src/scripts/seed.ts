...
const INITIAL_PRODUCTS_SEED = [
  {
    ...
    images: [
      ...
      { url: '/images/maternity/slide1.jpg', alt: 'Floral Anarkali Back View', isPrimary: false, sortOrder: 2 },
    ],
    variants: [
  ...
  },
  {
    ...
    images: [
      { url: '/images/maternity/slide3.jpg', alt: 'Embroidered Velvet Party Dress', isPrimary: true, sortOrder: 1 },
    ],
    variants: [
  ...
  {
    name: 'Organic Cotton Nursing Loungewear Pyjama Set',
    slug: 'organic-cotton-nursing-loungewear-pyjama-set',
    categorySlug: 'lounge-wear',
    productType: 'FEEDING',
    description: 'Super soft 100% organic cotton two-piece pyjama lounge set with horizontal 2-way zip nursing access.',
    shortDescription: 'Organic cotton nursing lounge set with pyjama',
    brand: 'YEZ BEE',
    price: 1149,
    compareAtPrice: 1599,
    discount: 28,
    ...
    bestSeller: true,
    newArrival: true,
    tags: ['loungewear', 'cotton', 'feeding', 'pyjamas', 'nightwear'],
    ...
    seo: { title: 'Organic Cotton Nursing Lounge Set | YEZ BEE', description: 'Soft nursing pyjama sets online.' },
  },
  {
    ...
    images: [
      { url: '/images/maternity/slide1.jpg', alt: 'Flared Peplum Top', isPrimary: true, sortOrder: 1 },
    ],
    variants: [
